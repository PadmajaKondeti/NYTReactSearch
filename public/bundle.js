...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
		...
		setStart: function setStart(startYear) {
			this.setState({
				startYear: startYear
			});
		},
		setEnd: function setEnd(endYear) {
			this.setState({
				endYear: endYear
			});
		},
			...
			if (prevState.searchTerm != this.state.searchTerm) {
				...
				helpers.runQuery(this.state.searchTerm, this.state.startYear, this.state.endYear).then(function (data) {
					if (data != this.state.results) {
						...
						helpers.postHistory(this.state.searchTerm, this.state.startYear, this.state.endYear).then(function (data) {
							console.log("Updated!");
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-md-6' },
						React.createElement(Form, { setTerm: this.setTerm, setStart: this.start, setEnd: this.setTerm })
					),
					React.createElement(
						'div',
						{ className: 'col-md-6' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = React.createClass({
		...
		handleClick: function handleClick() {
			...
			if (this.state.term.trim() != "") this.props.setTerm(this.state.term);
			if (this.state.startYear.trim() != "") {
				this.props.startYear(this.state.startYear);
			} else {
				this.props.startYear(2014);
			}
			if (this.state.endYear.trim() != "") {
				this.props.endYear(this.state.endYear);
			} else {
				this.props.startYear(2016);
			}
		},
	...
	var helpers = {
		...
		runQuery: function runQuery(topic, begin_date, end_date) {
			...
			return axios.get(queryURL).then(function (response) {
				...
				return response.data.result.docs[0];
			});
		},
